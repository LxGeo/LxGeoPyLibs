...
def parralel_rasterization(shapes_gdf, output_dst, burn_column):
    ...
    window_geometries = [ box(*rio.windows.bounds(c_window,output_dst.transform)) for c_window in windows_list]
    ...
    for c_window, c_window_geometrie in zip(windows_list, window_geometries):
        ...
        c_profile.update( 
            ...
            transform = rio.windows.transform(c_window,output_dst.transform)
            )
